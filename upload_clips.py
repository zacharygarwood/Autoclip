...
def upload_clips(clips):
    ...
    login_email = WebDriverWait(driver, 10).until(EC.element_to_be_clickable((By.XPATH, "//*[@id='identifierId']")))
    login_email.send_keys('<your login email>')

    email_next_button = WebDriverWait(driver, 10).until(EC.element_to_be_clickable((By.XPATH, "//*[@id='identifierNext']/div/button")))
    email_next_button.click()

    login_password = WebDriverWait(driver, 10).until(EC.element_to_be_clickable((By.XPATH, "//*[@id='password']/div[1]/div/div[1]/input")))
    login_password.send_keys('<your login password>')
    ...
    for clip in clips:
        if(initial):
            ...
            upload_videos_button = WebDriverWait(driver, 10).until(EC.element_to_be_clickable((By.XPATH, "/html/body/ytcp-app/ytcp-entity-page/div/ytcp-header/header/div/ytcp-text-menu/tp-yt-paper-dialog/tp-yt-paper-listbox/tp-yt-paper-item[1]")))
            upload_videos_button.click()

        select_files_button = WebDriverWait(driver, 10).until(EC.presence_of_element_located((By.XPATH, "/html/body/ytcp-uploads-dialog/tp-yt-paper-dialog/div/ytcp-uploads-file-picker/div/input")))
        select_files_button.send_keys('<path to video>')
        ...
        title_area.clear();
        title_area.send_keys(clip['title'])
        ...
        description_area.send_keys('<description goes here>')

        upload_thumbnail = WebDriverWait(driver, 10).until(EC.presence_of_element_located((By.XPATH, "/html/body/ytcp-uploads-dialog/tp-yt-paper-dialog/div/ytcp-animatable[1]/ytcp-video-metadata-editor/div/ytcp-video-metadata-editor-basics/div[3]/ytcp-thumbnails-compact-editor/div[3]/ytcp-thumbnails-compact-editor-uploader/input")))
        upload_thumbnail.send_keys('<path to thumbnail>')

        upload_videos_button = WebDriverWait(driver, 10).until(EC.element_to_be_clickable((By.XPATH, "/html/body/ytcp-uploads-dialog/tp-yt-paper-dialog/div/ytcp-animatable[1]/ytcp-video-metadata-editor/div/div/ytcp-button")))
        upload_videos_button.click()
        ...
        tags_area.send_keys('<Tags go here, separate with comma>')

        details_next_button = WebDriverWait(driver, 10).until(EC.element_to_be_clickable((By.XPATH, "/html/body/ytcp-uploads-dialog/tp-yt-paper-dialog/div/ytcp-animatable[2]/div/div[2]/ytcp-button[2]")))
        details_next_button.click()

        video_elements_next_button = WebDriverWait(driver, 10).until(EC.element_to_be_clickable((By.XPATH, "/html/body/ytcp-uploads-dialog/tp-yt-paper-dialog/div/ytcp-animatable[2]/div/div[2]/ytcp-button[2]")))
        video_elements_next_button.click()

        checks_next_button = WebDriverWait(driver, 10).until(EC.element_to_be_clickable((By.XPATH, "/html/body/ytcp-uploads-dialog/tp-yt-paper-dialog/div/ytcp-animatable[2]/div/div[2]/ytcp-button[2]")))
        checks_next_button.click()

        visibility_public_button = WebDriverWait(driver, 10).until(EC.element_to_be_clickable((By.XPATH, "/html/body/ytcp-uploads-dialog/tp-yt-paper-dialog/div/ytcp-animatable[1]/ytcp-uploads-review/div[2]/div[1]/ytcp-video-visibility-select/div[1]/tp-yt-paper-radio-group/tp-yt-paper-radio-button[3]")))
        visibility_public_button.click()

        publish_button = WebDriverWait(driver, 10).until(EC.element_to_be_clickable((By.CSS_SELECTOR,"#done-button[aria-disabled='false']")))
